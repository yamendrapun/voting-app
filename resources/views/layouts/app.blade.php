                ...
                >
                    ...
                    @else 
                        <div class="my-6 text-center">
                            <a 
                                href="{{ route('login') }}" 
                                class="inline-block justify-center w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border text-white border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                            >
