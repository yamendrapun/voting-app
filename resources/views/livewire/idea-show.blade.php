<div class="idea-and-buttons container">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if($hasVoted)
                <button type="button" class="w-32 h-11 text-xs bg-blue text-white font-semibold rounded-xl uppercase border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                    <span>Voted</span>
                </button>
            @else
