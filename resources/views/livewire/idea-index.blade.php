        ...
        <div class="mt-8">
            @if($hasVoted)
                <button 
                    ...
                    class="w-20 bg-blue border border-blue hover:bg-blue-hover font-bold text-xxs text-white uppercase rounded-xl transition duration-150 ease-in px-4 py-3">
                    Voted
                </button>   
            @else
                <button 
